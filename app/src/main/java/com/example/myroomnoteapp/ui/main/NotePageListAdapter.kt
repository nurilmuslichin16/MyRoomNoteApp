...
import com.example.myroomnoteapp.databinding.ItemNoteBinding
import com.example.myroomnoteapp.ui.insert.NoteAddUpdateActivity

class NotePageListAdapter(private val activity: Activity): PagedListAdapter<Note, NotePageListAdapter.NoteViewHolder>(DIFF_CALLBACK) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): NotePageListAdapter.NoteViewHolder {
